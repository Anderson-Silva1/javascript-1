...
//     ++ -> Incremento
{
  ...
  // Esse tipo de atrubuição será visivelmente vista quando estivermos falando de estrutura de repetição
}
...
//     -- -> Decremento
{
  ...
  // Nesse caso ele decrementa primeiro
  // Esse tipo de atrubuição será visivelmente vista quando estivermos falando de estrutura de repetição
}
...
//     ** -> Expenenciação
{
  ...
  exponente = num2 ** num1; // 10 elevado a 20
