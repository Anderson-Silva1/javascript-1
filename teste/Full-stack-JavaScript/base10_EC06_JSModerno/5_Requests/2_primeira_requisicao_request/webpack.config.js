...
module.exports = {
    ...
    resolve: {
        fallback: {
            "domain": require.resolve("domain-browser"), // Usa 'domain-browser' como fallback
            "fs": false, // Caso o 'fs' seja utilizado, desabilite (não pode ser usado no navegador)
            "path": false // Desabilita o módulo 'path' no navegador
            // Outros polyfills podem ser adicionados aqui se necessário
        }
    },
